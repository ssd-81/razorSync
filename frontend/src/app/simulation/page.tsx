...
export default function SimIndex(){
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <p className="rz-page-desc">Customers are generated from fixed seeds and every proposal is checked against the same rules as live traffic. Toggle a rule in <Link href="/rules" className="text-[#0B5CFF] font-medium hover:underline">Rules</Link> → re-run → numbers shift, with false positives tracked throughout.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="rz-card p-5">
          ...
          <p className="text-sm text-slate-600 mt-2 leading-relaxed">Simulation checks every proposal against the live rule set — same time windows, same limits, same thresholds.</p>
        </div>
        <div className="rz-card p-5">
